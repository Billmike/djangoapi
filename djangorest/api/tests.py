...
class ViewTestCase(TestCase):
	...
	def setUp(self):
		...
		#force authentication of client
	...
	def test_api_can_update_bucketlist(self):
		...
		res = self.client.put(reverse('details'), kwargs ={'pk': bucketlist.id}, format ="json")
